...
* [@angular-extensions/model](https://github.com/angular-extensions/model) - Manage state via a single (service-like) API (see [here for its motivation](https://blog.angularindepth.com/model-pattern-for-angular-state-management-6cb4f0bfed87#1905)).
...
* [Overmind](https://overmindjs.org/?view=angular&typescript=true) - State management that tries to keep it simple.
